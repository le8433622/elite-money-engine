  ...
  return (
    <div className="mx-auto flex min-h-[80vh] max-w-6xl items-center px-6 py-10">
      <div className="mx-auto w-full max-w-md rounded-3xl border border-slate-800 bg-slate-900 p-8">
        ...
        <p className="mt-3 text-slate-300">Start tracking transactions, budgets, and automation rules.</p>

        <div className="mt-8 space-y-4">
          <div>
            <label className="mb-2 block text-sm text-slate-300">Full name</label>
            <input className="w-full rounded-2xl border border-slate-700 bg-slate-950 px-4 py-3 text-slate-100 outline-none" placeholder="Your name" />
          </div>
          <div>
          ...
          <button className="w-full rounded-2xl bg-sky-500 px-4 py-3 font-medium text-slate-950">Create account</button>
        </div>
      </div>
    </div>
  );
